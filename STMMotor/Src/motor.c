...
void pwm_init(void) {
	...
	/// TODO: Set up a pin for H-bridge PWM output (TIMER 16 CH1) - use PB8 -> AF2
		GPIOB->MODER |= 0x20000; GPIOB->MODER &= ~0x10000;
		GPIOB->AFR[1] |= 0x2; GPIOB->AFR[1] &= ~0xD;
    
    /// TODO: Set up a few GPIO output pins for direction control - use PA4,PA5
...
void encoder_init(void) {
	...
	/// TODO: Set up encoder input pins (TIMER 3 CH1 and CH2) : PA4,PA5 -> AF1
     ...
     */ 
    TIM6->PSC = SystemCoreClock/1000000 - 1; // Change this!
...
void PI_update(void) {
    ...
    int16_t output = error_integral + error_proportional; // Change this!
